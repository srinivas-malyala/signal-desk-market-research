...
|---|---|---|---|
| 9.1 Deployment | Prepared, externally blocked | Bundle resources, configuration contract, manual MCP deployment guide, and deployment checklist | Renew OAuth, resolve admin secret-resource permissions, then deploy MCP, Supervisor, analytics, and frontend |
