...
| 5 — MCP agent tools | In progress | Existing retrieval/write tools characterized; section-aware/Qwen3/managed-AI-Search design and evaluation targets accepted in ADR 0005 | Canonical chunks/index, safe traces, trusted identity, confirmation/idempotency, retrieval evaluation, workspace acceptance |
