...
| 5 — MCP agent tools | In progress | Existing tools characterized; ADR 0005 accepted; canonical section-aware parent/child chunk contract and CDF source implemented and tested | Managed index/search client, safe traces, trusted identity, confirmation/idempotency, retrieval evaluation, workspace acceptance |
