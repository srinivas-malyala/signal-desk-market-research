...
| 4 — Lakebase | In progress | Admin-managed secret verified; strict shared-schema table registry, checksum-protected versioned migrations, CDC replica-identity migration, and bounded connection pool implemented locally | Refactor application SQL, verify live permissions/migrations/CRUD, finish reconnect tests, and prove identity isolation |
